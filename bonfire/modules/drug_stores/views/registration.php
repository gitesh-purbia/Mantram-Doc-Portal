			...
			<div class="container">
				...
				<div class="inner-page-title-wrap col-xs-12 col-md-12 col-sm-12">
					<div class="bread-heading">
						<h1>Drug stores's Registration</h1>
					</div>
					<div class="bread-crumb pull-right">
						<ul>
							...
							<li>
								<a href="registration">Drug stores's Registration</a>
							</li>
						</ul>
					</div>
				</div>
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 pull-left blgo-full-wrap no-pad">
				...
				<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 pull-left no-pad">
					<div class="form-widget wow fadeInLeft" data-wow-delay="0.5s" data-wow-offset="200" style="padding-top: 0;">
						...
						<?php
						$attributes = array('id' => 'drug_stores_registration_form', 'name' => 'drug_stores_registration_form', 'autocomplete' => 'off', 'class' => 'appt-form');
						echo form_open('drug_stores/registration', $attributes);
						?>
						<?php
						echo Template::message();
						?>
						<input required="required" type="text" name="dsln" class="appt-form-txt" placeholder="Drug store's License Number(required)" value="<?php echo set_value('dsln', isset($drug_store['dsln']) ? $drug_store['dsln'] : ''); ?> " />
						<input required="required" type="text" name="name" class="appt-form-txt" placeholder="Drug store's Name(required)" value="<?php echo set_value('first_name', isset($drug_store['first_name']) ? $drug_store['first_name'] : ''); ?>"/>
						<input required="required" type="text" name="mobile" class="appt-form-txt" placeholder="Mobile Number(required)" value="<?php echo set_value('mobile', isset($drug_store['mobile']) ? $drug_store['mobile'] : ''); ?>" />
						<input required="required" type="email" name="email" class="appt-form-txt" placeholder="Email(required)" value="<?php echo set_value('email', isset($drug_store['email']) ? $drug_store['email'] : ''); ?>" />
