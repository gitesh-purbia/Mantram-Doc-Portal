			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 pull-left blgo-full-wrap no-pad">
				...
				<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 pull-left no-pad">
					<div class="form-widget wow fadeInLeft" data-wow-delay="0.5s" data-wow-offset="200" style="padding-top: 0;">
						...
						<?php
						$attributes = array('id' => 'doctor_registration_form', 'name' => 'doctor_registration_form', 'autocomplete' => 'off', 'class' => 'appt-form');
						echo form_open('doctors/registration', $attributes);
						?>
						<?php
						echo Template::message();
						?>
						<input required="required" type="text" name="dln" class="appt-form-txt" placeholder="Doctor License Number(required)" value="<?php echo set_value('dln', isset($doctor['dln']) ? $doctor['dln'] : ''); ?>" />
						<input required="required" type="text" name="first_name" class="appt-form-txt" placeholder="First Name(required)" value="<?php echo set_value('first_name', isset($doctor['first_name']) ? $doctor['first_name'] : ''); ?>" />
						...
						<input required="required" type="text" name="last_name" class="appt-form-txt" placeholder="Last Name(required)" value="<?php echo set_value('last_name', isset($doctor['last_name']) ? $doctor['last_name'] : ''); ?>" />
						<input required="required" type="text" name="mobile" class="appt-form-txt" placeholder="Mobile Number(required)" value="<?php echo set_value('mobile', isset($doctor['mobile']) ? $doctor['mobile'] : ''); ?>" />
						<input required="required" type="email" name="email" class="appt-form-txt" placeholder="Email(required)" value="<?php echo set_value('email', isset($doctor['email']) ? $doctor['email'] : ''); ?>" />
