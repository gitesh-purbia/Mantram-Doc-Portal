					...
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
						<div class="form-widget wow fadeInLeft" data-wow-delay="0.5s" data-wow-offset="200">
							...
							<?php
								...
								echo form_open('labs/mobile_verification', $attributes);
							?>
							<input type="hidden" name="id" value="<?php echo $id; ?>"/>
							<input type="hidden" name="user_id" value="<?php echo $user_id; ?>"/>
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 pull-left no-pad" style="text-align: center;">
								<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
									<input type="text" name="mobile_code" class="appt-form-txt" placeholder="Enter Code"  value="<?php echo set_value('mobile_code', isset($lab['mobile_code']) ? $lab['mobile_code'] : ''); ?>" />
