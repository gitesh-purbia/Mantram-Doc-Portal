<div class="topbar-info no-pad">
	<div class="container">
		...
		<div class="top-info-contact pull-right col-md-6">
			<?php if(!$this->auth->is_logged_in()):?><a href="javascript:void(0)" id="login">Login |</a><a href="<?php echo FRONT_URL;?>registration">Register with us</a><?php else:?><span>Welcome, <?php echo $current_user->display_name;?></span><?php endif; ?>   |    Call Us Today! +123 455 755  |    contact@ilaaj.com
		</div>
	</div>
</div>