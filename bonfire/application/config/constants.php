...
define('FRONT_URL', 'http://localhost/ilaaj_front/');
...
unset ( $ajax_request );
 ...
 define('TYPE_DOCTOR', 'doctors');
 define('TYPE_PATIENT', 'patients');
 define('TYPE_LAB', 'labs');
 define('TYPE_DRUG_STORE', 'drugStores');
