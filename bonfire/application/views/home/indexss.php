<div class="complete-content">
	...
	<div class="container full-width-container banner custom-banner-height">
		<div data-wow-offset="200" data-wow-delay="1.7s" class="col-xs-12 col-sm-10 col-md-10 content-tabs-wrap wow fadeInUp animated" style="visibility: visible;-webkit-animation-delay: 1.7s; -moz-animation-delay: 1.7s; animation-delay: 1.7s;">
			<form class="searchform cf">
				 <ul class="nav nav-tabs">
	                  <li class="active"><a href="#speciality" data-toggle="tab">SPECIALITY</a></li>
	             ...
	             <div class="tab-content">
	                 <div class="tab-pane fade in active" id="speciality">
	                 	<input type="text" placeholder="Speciality:- eg: Dentist">
	                 </div>
	                 <div class="tab-pane fade" id="doctor">
	                 	<input type="text" placeholder="eg: Dr. XYZXYZ">
	                 </div>
	                 <div class="tab-pane fade" id="clinic">
	                 	<input type="text" placeholder="eg: ABC Dental Clinic">
	                 </div>
                 </div>
                 <div>
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 pull-right">
					<div class="purchase-strip-blue pull-right col-sm-12 col-md-12 col-xs-12 pull-left notViewed wow fadeInUp" data-wow-delay="0.5s" data-wow-offset="150">
						<div class="purchase-strip-text">
							IMEDICA IS CLEAN AND <span class="ipurcahse-strip-text">PROFESSIONAL</span> THEME FOR YOU !
						</div>
						<div class="color-4">
							<p class="ipurchase-paragraph">
								<button class="icon-cart btn btn-4 btn-4a notViewed wow fadeInUp" data-wow-delay="0.5s" data-wow-offset="150">
									Purchase Theme
								</button>
							</p>
						</div>
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 pull-left client-logo-flex wow fadeInUp" data-wow-delay="0.5s" data-wow-offset="100">
					...
					<ul id="clients-carousel" class="icl-carousel">
						<li>
							<a href="#"><img src="<?php echo Template::theme_url('images/nlogo1.png')?>" alt="" class="img-responsive client-logo-img"/></a>
						</li>
						<li>
							<a href="#"><img src="<?php echo Template::theme_url('images/nlogo2.png')?>" alt="" class="img-responsive client-logo-img"/></a>
						</li>
						<li>
							<a href="#"><img src="<?php echo Template::theme_url('images/nlogo3.png')?>" alt="" class="img-responsive client-logo-img"/></a>
						</li>
						<li>
							<a href="#"><img src="<?php echo Template::theme_url('images/nlogo4.png')?>" alt="" class="img-responsive client-logo-img"/></a>
						</li>
						<li>
							<a href="#"><img src="<?php echo Template::theme_url('images/nlogo5.png')?>" alt="" class="img-responsive client-logo-img"/></a>
						</li>
						<li>
							<a href="#"><img src="<?php echo Template::theme_url('images/nlogo6.png')?>" alt="" class="img-responsive client-logo-img"/></a>
						</li>
					</ul>
